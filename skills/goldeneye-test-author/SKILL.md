...
Use this skill when adding or updating Goldeneye USD render tests, references, thresholds, fixture docs, or suspect metadata.
...
3. Add `.usd`, `.usda`, `.usdc`, or `.usdz` fixtures under the suite section where they should appear in reports.
