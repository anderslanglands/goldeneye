...
- [GitHub CLI (`gh`)](https://cli.github.com/manual/installation) authenticated for the target repository, to download or publish reference archives in GitHub Releases.
